...
CREATE TABLE autokinito
    (
        ...
        FOREIGN KEY(pelatis_id) REFERENCES pelatis(pelatis_id),
...
CREATE TABLE aitima
    (
        ...
        FOREIGN KEY(autokinito_id) REFERENCES autokinito(autokinito_id)
    );
...
CREATE TABLE syntirisi
    (
        ...
        FOREIGN KEY(aitima_id) REFERENCES aitima(aitima_id)
    );
...
CREATE TABLE eksipiretisi_vlavis
    (
        ...
        FOREIGN KEY(ypalilos_id) REFERENCES ypalilos(ypalilos_id),
        FOREIGN KEY(vlavi_idAutokinito) REFERENCES vlavi(vlavi_idAutokinito)
    );
...
CREATE TABLE eksipiretisi_syntirisis
    (
        ...
        FOREIGN KEY(syntirisi_id) REFERENCES syntirisi(syntirisi_id),
        FOREIGN KEY(ypalilos_id) REFERENCES ypalilos(ypalilos_id)
    );
